...
<script type="text/javascript">
	...
	function enviarFormulario() {
		var especialidadId = parseInt(
				document.getElementById('especialidad').value, 10);
			...
			<table class="formulario">
				...
				<tr>
					<td><a style="font-family: Arial; font-size: 150%">Fecha
							Inicio</a></td>
					<td><input type="date" class="inputForm" id="fechaInicio"
						name="fechaInicio" style="width: 100%; text-align: center;"></td>
				</tr>
				<tr>
					<td><a style="font-family: Arial; font-size: 150%">Fecha
							Fin</a></td>
					<td><input class="inputForm" type="date" id="fechaFin"
						name="fechaFin" value="<%=LocalDateTime.now().toLocalDate()%>"
				...
				<tr>
					...
					<td>
						<div class="center">
							...
							<button id="btnObtenerReporte" type="button" class="btn btn-dark">Obtener
								Reporte</button>
						</div>
					</td>
				</tr>
		...
		<div class="container">
			...
			<table class="formulario">
				<tr>
					...
					<td><select id="medico" name="medicoId" class="form-select"
						aria-label="Default select example" required>
							<option value="" disabled selected hidden >Seleccione Medico</option>
							<c:forEach var="medico" items="${listaMedicos}">
								<option value="${medico.matricula}">
									${medico.getNombre()}, ${medico.getApellido()}</option>
							</c:forEach>
					</select></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><select name="idEstado" class="form-select"
						aria-label="Default select example" required>
							<option value="" disabled selected hidden>Seleccion un estado</option>
