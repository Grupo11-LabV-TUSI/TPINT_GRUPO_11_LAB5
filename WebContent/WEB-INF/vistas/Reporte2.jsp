...
<script type="text/javascript">
	$(document).ready(
			function() {
				...
				$('#detalleTurnoModal .btn-secondary[data-dismiss="modal"]')
						.click(function() {
							$('#detalleTurnoModal').modal('hide');
						});
	...
	<div class="container">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="resultadoModalLabel">Resultado del
					Reporte</h5>
			...
			<div class="modal-body">
				<table class="formulario">
					...
					<tr>
						<td><b style="font-size: 160%;">Medico - Matricula: </b> <span
							style="font-family: courier; font-size: 180%;"> ${medico.nombre}
								- ${medico.matricula}</span></td>
					</tr>
					<tr>
						<td><b style="font-size: 160%;">Cantidad de pacientes:</b><span
							style="font-size: 180%;"> ${cantTurno} </span></td>
					</tr>
					<tr>
						<td><b style="font-size: 160%;">Estado de turno:</b><span
							style="font-size: 180%;"> ${estadoTurno} </span></td>
					</tr>
					<tr>
						<td><b style="font-size: 160%;">MES:</b><span
							style="font-size: 180%;"> ${mes}</span></td>
						<td><b style="font-size: 160%;">AÑO:</b><span
							style="font-size: 180%;"> ${anio}</span></td>
					</tr>
				</table>
			</div>
